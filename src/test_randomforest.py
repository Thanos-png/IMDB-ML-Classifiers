...
def plot_test_results_B(categories, prec_values, rec_values, f1_values, sklearn_precs, sklearn_recs, sklearn_f1s):
    ...
    plt.xlabel("Categories")
    plt.ylabel("Score")
    plt.title("Test Evaluation Metrics: Custom vs Sklearn Random Forest")
    plt.xticks(x, categories)
    plt.ylim(0, 1)
...
def main():
    ...
    preds = randomforest_predict(X_test, forest)
    ...
    print(f"\nLoaded trained Sklearn Random Forest model from {sklearn_model_path}")
    ...
    print("\nCustom Random Forest Test Evaluation Metrics:")
    ...
    print("\nSklearn Random Forest Test Evaluation Metrics:")
    print("{:<10} {:<10} {:<10} {:<10}".format("Category", "Precision", "Recall", "F1"))
    ...
    print("\nCustom Random Forest Micro-averaged: Precision: {:.4f}, Recall: {:.4f}, F1: {:.4f}".format(micro_prec, micro_rec, micro_f1))
    print("Custom Random Forest Macro-averaged: Precision: {:.4f}, Recall: {:.4f}, F1: {:.4f}".format(macro_prec, macro_rec, macro_f1))

    print("\nSklearn Random Forest Micro-averaged: Precision: {:.4f}, Recall: {:.4f}, F1: {:.4f}".format(sklearn_acc, sklearn_acc, sklearn_acc))
    print("Sklearn Random Forest Macro-averaged: Precision: {:.4f}, Recall: {:.4f}, F1: {:.4f}".format(sklearn_macro_prec, sklearn_macro_rec, sklearn_macro_f1))
